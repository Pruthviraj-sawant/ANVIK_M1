...
// export async function getGoogleAuthUrl(telegramId) {
//   const url = oauth2Client.generateAuthUrl({
//     access_type: 'offline',       // must have underscore
//     prompt: 'consent',
...
// // store tokens for telegram user
// await User.findOneAndUpdate({ telegramId: String(stateTelegramId) }, { google: tokens }, { upsert: true });
// }
...
// // details expects: title, start (ISO), end (ISO), description
// const event = {
// summary: details.title || 'Anvik Event',
